    ...
    IUserService userService)
        {
            ...
            //Here we can verify the username and password and generate the token using the below code
            bool resp = await userService.isValidUser(userName, password);
        ...
        //
        static string CreateAccessToken(JwtOptions jwtOptions,string username,
                                    TimeSpan expiration,string[] permissions)
        {
